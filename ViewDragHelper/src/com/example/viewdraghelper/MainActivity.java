...
import com.example.viewdraghelper.SlideMenu2.OnDragStatusChangeListener;
import com.example.viewdraghelper.SlideMenu2.Status;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		head.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				if(slideMenu2.mStatus==Status.Close){
					slideMenu2.open();
				}
			}
		});
		...
		slideMenu2.setOnDragStatusChangeListener(new OnDragStatusChangeListener() {
			@Override
			public void onOpen() {
